...
class CartsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'product_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'price' => 1,
            'quantity' => 1,
            'created' => '2017-11-12 13:30:08',
            'modified' => '2017-11-12 13:30:08',
            'status' => 1
        ],
    ];
}
