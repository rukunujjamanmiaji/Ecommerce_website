...
var B2 = function () {
    ...
    var assetsPath = 'http://abacustutor.local';
...
var Layout = function () {
    ...
    var handle100HeightContent = function () {
        ...
        if (target.hasClass('portlet')) {
            ...
            if (B2.getViewPort().width < resBreakpointMd) {
                B2.destroySlimScroll(portletBody.find('.full-height-content-body')); // destroy slimscroll 
                return;
            }
            ...
            if (target.hasClass("full-height-content-scrollable")) {
                ...
                B2.initSlimScroll(portletBody.find('.full-height-content-body'));
            } else {
                portletBody.css('min-height', height);
            }
        } else {
            if (B2.getViewPort().width < resBreakpointMd) {
                B2.destroySlimScroll(target.find('.full-height-content-body')); // destroy slimscroll 
                return;
            }
            ...
            if (target.hasClass("full-height-content-scrollable")) {
                ...
                B2.initSlimScroll(target.find('.full-height-content-body'));
            } else {
    ...
    return {
        ...
        initContent: function () {
            ...
            B2.addResizeHandler(handleSidebarAndContentHeight); // recalculate sidebar & content height on window resize
            B2.addResizeHandler(handle100HeightContent); // reinitialize content height on window resize 
        },
        initFooter: function () {
...
var QuickSidebar = function () {
    ...
    var handleQuickSidebarChat = function () {
        ...
        var initChatSlimScroll = function () {
            ...
            // chat user list 
            B2.destroySlimScroll(chatUsers);
            chatUsers.attr("data-height", chatUsersHeight);
            B2.initSlimScroll(chatUsers);

            var chatMessages = wrapperChat.find('.page-quick-sidebar-chat-user-messages');
            var chatMessagesHeight = chatUsersHeight - wrapperChat.find('.page-quick-sidebar-chat-user-form').outerHeight() - wrapperChat.find('.page-quick-sidebar-nav').outerHeight();

            // user chat messages 
            B2.destroySlimScroll(chatMessages);
            chatMessages.attr("data-height", chatMessagesHeight);
            B2.initSlimScroll(chatMessages);
        };

        initChatSlimScroll();
        B2.addResizeHandler(initChatSlimScroll); // reinitialize on window resize
    ...
    var handleQuickSidebarAlerts = function () {
        ...
        var initAlertsSlimScroll = function () {
            ...
            // alerts list 
            B2.destroySlimScroll(alertList);
            alertList.attr("data-height", alertListHeight);
            B2.initSlimScroll(alertList);
        };

        initAlertsSlimScroll();
        B2.addResizeHandler(initAlertsSlimScroll); // reinitialize on window resize
    };
    ...
    var handleQuickSidebarSettings = function () {
        ...
        var initSettingsSlimScroll = function () {
            ...
            // alerts list 
            B2.destroySlimScroll(settingsList);
            settingsList.attr("data-height", settingsListHeight);
            B2.initSlimScroll(settingsList);
        };

        initSettingsSlimScroll();
        B2.addResizeHandler(initSettingsSlimScroll); // reinitialize on window resize
    };
        ...
        init: function (totalpages, visible, current, type) {
            ...
            $('#pagination').twbsPagination({
                ...
                if (type === 'Contact_index') {
                    window.history.pushState({}, $(document).attr('title'), "/contacts" + "?" + url_params);
                    B2.startPageLoading({animate: true});
                    window.location = "/contacts" + "?" + url_params;
                }
