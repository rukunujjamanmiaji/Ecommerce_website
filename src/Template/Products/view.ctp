...
<div class="container">
    ...
    <div class="row product-info">
        <div class="col-md-6">
            ...
            <div class="image"><a class="cloud-zoom" rel="adjustX: 0, adjustY:0" id='zoom1'
                                  href="../../products/dress1home.jpg" title="Nano"><?= $this->
                Html->image('../products/dress1home.jpg', ['alt' => 'Nano', 'title' => 'Nano', 'id' => 'image']) ?></a>
            </div>
            <div class="image-additional">
                <a title="Dress" rel="useZoom: 'zoom1', smallImage: 'products/dress1home.jpg'"
                   class="cloud-zoom-gallery" href="products/dress1home.jpg"><?= $this->
                    Html->image('../products/dress1home.jpg', ['alt' => 'Dress', 'title' => 'Dress', 'id' => 'image'])
                    ?></a>
                <a title="Dress" rel="useZoom: 'zoom1', smallImage: 'products/dress5home.jpg'"
                   class="cloud-zoom-gallery" href="products/dress5home.jpg"><?= $this->
                    Html->image('../products/dress5home.jpg', ['alt' => 'Dress', 'title' => 'Dress', 'id' => 'image'])
                    ?></a>
                <a title="Dress" rel="useZoom: 'zoom1', smallImage: 'products/dress6home.jpg'"
                   class="cloud-zoom-gallery" href="products/dress6home.jpg"><?= $this->
                    Html->image('../products/dress6home.jpg', ['alt' => 'Dress', 'title' => 'Dress', 'id' => 'image'])
                    ?></a>
                <a title="Dress" rel="useZoom: 'zoom1', smallImage: 'products/dress4home.jpg'"
                   class="cloud-zoom-gallery" href="products/dress4home.jpg"><?= $this->
                    Html->image('../products/dress4home.jpg', ['alt' => 'Dress', 'title' => 'Dress', 'id' => 'image'])
                    ?></a>
            </div>
        </div>
        <div class="col-md-6">
            ...
            <ul>
                ...
                <li><span>Availability: </span><?= ($product['units_in_stock'] > 0) ? 'In Stock' : 'Not available' ?>
                </li>
            </ul>
            <div class="price">
                Price
                ...
                echo '<strong>'. $this->number->currency( $product['sell_price'] - ($product['sell_price'] *
                ($product['discounts'][0]['amount'] / 100) )) .'</strong>';
                } else {
            ...
            echo 'view this products';
            }
            ?>
            <div class="line"></div>
            <form class="form-inline" method="post"
                  action="<?php echo Router::url(['controller' => 'Carts', 'action' => 'add']); ?>">
